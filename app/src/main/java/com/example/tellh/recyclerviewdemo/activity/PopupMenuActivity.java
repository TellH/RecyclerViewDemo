...
import com.example.tellh.recyclerviewdemo.listener.OnShowPopupMenuClickListener;
    ...
    private void init() {
        ...
        mAdapter = new BaseRecyclerAdapter<String>(this,mDataList) {
            ...
            protected void bindData(RecyclerViewHolder holder, int position,String item) {
                ...
                holder.getView(R.id.iv_reorder).setOnClickListener(new OnShowPopupMenuClickListener(PopupMenuActivity.this,recyclerView,holder));
            }
        };
        ...
        ((BaseRecyclerAdapter)mAdapter).setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View itemView, int pos) {
                Toast.makeText(PopupMenuActivity.this, "click " + pos, Toast.LENGTH_SHORT).show();
            }
        });
        ((BaseRecyclerAdapter)mAdapter).setOnItemLongClickListener(new BaseRecyclerAdapter.OnItemLongClickListener() {
            @Override
            public void onItemLongClick(View itemView, int pos) {
                Toast.makeText(PopupMenuActivity.this, "long click " + pos, Toast.LENGTH_SHORT).show();
            }
        });
        //设置布局样式LayoutManager
        recyclerView.setLayoutManager(new LinearLayoutManager(PopupMenuActivity.this, LinearLayoutManager.VERTICAL, false));
